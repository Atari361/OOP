...
public class HomeWorkDescription {
    /*
3. Создайте интерфейс описывающий учебную группу студентов (с возможностью зачисления студентов в группу,
удаления студента из группы),
и не основании его создайте класс Группа — который содержит массив из 10 объектов класса студент.
Реализуйте метод поиска студента по фамилии.
